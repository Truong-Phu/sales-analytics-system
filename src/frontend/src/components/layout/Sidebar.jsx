...
const NAV = [
    ...
    { to: '/import', icon: '📥', label: 'Import dữ liệu', roles: ['Admin', 'Staff'] },
    { to: '/logs', icon: '📝', label: 'Nhật ký', roles: ['Admin'] },
];

const ROLE_META = {
    Admin: { color: 'var(--red)', bg: 'rgba(255,107,107,.12)', icon: '🛡', desc: 'Toàn quyền' },
    Manager: { color: 'var(--amber)', bg: 'rgba(255,192,72,.12)', icon: '📊', desc: 'Xem thống kê' },
    Staff: { color: 'var(--blue)', bg: 'rgba(96,180,250,.12)', icon: '🧑‍💼', desc: 'Nhập liệu' },
};
            ...
            <aside className="sidebar">
                        ...
                        return (
                            <NavLink key={item.to} to={item.to} end
                                ...
                                {item.pendingBadge && pendingCount > 0 && (
                                    <span className="sb-badge" style={{ background: 'rgba(255,192,72,.2)', color: 'var(--amber)' }}>
                                        {pendingCount}
                                    </span>
                                )}
                            </NavLink>
                ...
                <div className="sb-footer">
                    ...
                    <div className="sb-user">
                        ...
                        <button className="sb-logout" onClick={() => setShowConfirm(true)} title="Đăng xuất">⏏</button>
                    </div>
                </div>
            </aside>
                    ...
                    <div className="modal" style={{ width: 360 }} onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <div style={{ textAlign: 'center', padding: '8px 0' }}>
                                ...
                                <div style={{ fontSize: 14, marginBottom: 6 }}>Bạn có chắc muốn đăng xuất?</div>
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-ghost" onClick={() => setShowConfirm(false)} disabled={loggingOut}>Hủy</button>
